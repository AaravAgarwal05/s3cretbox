...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-50 via-emerald-50/30 to-zinc-100 dark:from-zinc-950 dark:via-emerald-950/20 dark:to-zinc-900">
      {/* Fixed Theme Toggle */}
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="relative mb-8">
            <div className="w-32 h-32 mx-auto mb-6 relative">
              {/* Background Circle */}
              <div className="absolute inset-0 bg-gradient-to-br from-emerald-100 to-emerald-200 dark:from-emerald-900/30 dark:to-emerald-800/30 rounded-full animate-pulse"></div>
            ...
            {/* 404 Text */}
            <div className="text-8xl md:text-9xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-emerald-400 dark:from-emerald-400 dark:to-emerald-300 mb-4 tracking-tighter">
              404
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/60 dark:bg-zinc-900/60 backdrop-blur-sm rounded-2xl p-6 border border-zinc-200 dark:border-zinc-700">
              ...
              <div className="grid gap-3 text-sm text-zinc-600 dark:text-zinc-400">
                ...
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-emerald-500 rounded-full mr-3"></div>
                  Visit our dashboard to explore your buckets
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-emerald-500 rounded-full mr-3"></div>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-40 right-20 w-1 h-1 bg-emerald-500 rounded-full animate-ping opacity-40"></div>
        <div className="absolute bottom-32 left-20 w-3 h-3 bg-emerald-300 rounded-full animate-pulse opacity-50"></div>
        <div className="absolute bottom-20 right-10 w-1.5 h-1.5 bg-emerald-400 rounded-full animate-ping opacity-60"></div>

        {/* Larger decorative circles */}
        <div className="absolute top-1/4 -left-20 w-40 h-40 bg-gradient-to-br from-emerald-100/20 to-transparent rounded-full"></div>
