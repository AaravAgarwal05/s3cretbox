...
import { BucketDialog, BucketList, SidebarContent } from "./components";

// Data structure for S3 buckets
interface S3Bucket {
  id: string;
  name: string;
  region: string;
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="flex h-screen">
        ...
        <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
          <SheetTrigger asChild>
            <Button
              variant="outline"
              size="icon"
              className="fixed top-4 left-4 z-40 bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-700 hover:bg-zinc-100 dark:hover:bg-zinc-800"
            >
          ...
          <SheetContent
            side="left"
            className="w-80 p-0 bg-white dark:bg-zinc-900"
          >
            <SidebarContent
        ...
        {/* Standalone Add Bucket Dialog - triggered from landing page button */}
        <BucketDialog
          isAddDialogOpen={isAddDialogOpen}
          setIsAddDialogOpen={setIsAddDialogOpen}
          newBucket={newBucket}
        ...
        {/* Main Content */}
        <div className="flex-1 overflow-auto bg-gradient-to-br from-orange-50 via-zinc-50 to-emerald-50 dark:from-orange-950/30 dark:via-zinc-950 dark:to-emerald-950/30">
          {selectedBucket ? (
            ...
            // Welcome/Landing content when no bucket is selected
            <div className="overflow-auto pt-16 min-h-screen">
              {/* Hero Section */}
              <section className="relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-orange-200/30 to-emerald-200/30 dark:from-orange-800/20 dark:to-emerald-800/20" />
                  ...
                  <div className="text-center">
                    <div className="flex justify-center items-center mb-6">
                      <div className="relative">
                        <div className="w-16 h-16 bg-gradient-to-r from-orange-600 to-emerald-600 dark:from-orange-400 dark:to-emerald-400 rounded-2xl flex items-center justify-center shadow-lg">
                    ...
                    <p className="text-zinc-500 dark:text-zinc-500 mb-8 max-w-xl mx-auto">
                      Securely manage your AWS S3 files with local storage, zero
                      backend, and complete privacy control.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                      ...
                      <Link href="/demo-bucket">
                        <Button
                          variant="outline"
                          size="lg"
                          className="border-2 border-emerald-300 dark:border-emerald-700 px-8 py-6 text-lg font-semibold rounded-xl hover:bg-emerald-50 dark:hover:bg-emerald-950/20 transition-all duration-200"
                        >
                      ...
                      <Link href="/aws-guide">
                        <Button
                          variant="outline"
                          size="lg"
                          className="border-2 border-blue-300 dark:border-blue-700 px-8 py-6 text-lg font-semibold rounded-xl hover:bg-blue-50 dark:hover:bg-blue-950/20 transition-all duration-200"
                        >
              ...
              <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <Card className="border-2 hover:border-zinc-300 dark:hover:border-zinc-600 transition-all duration-200 shadow-sm hover:shadow-md">
                    ...
                    <CardContent>
                      <CardDescription className="text-center text-zinc-600 dark:text-zinc-400">
                        Your AWS credentials are stored only in your browser. No
                        server-side storage.
                      </CardDescription>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-2 hover:border-zinc-300 dark:hover:border-zinc-600 transition-all duration-200 shadow-sm hover:shadow-md">
                    ...
                    <CardContent>
                      <CardDescription className="text-center text-zinc-600 dark:text-zinc-400">
                        Navigate through all your S3 buckets with an intuitive,
                        modern interface.
                      </CardDescription>
                    </CardContent>
                  </Card>
              ...
              <section className="bg-white/40 dark:bg-zinc-900/40 backdrop-blur-sm py-12">
                  ...
                  <div className="grid md:grid-cols-3 gap-8">
                    <div className="text-center">
                      <div className="relative mb-4">
                        <div className="w-14 h-14 bg-zinc-900 dark:bg-zinc-100 rounded-2xl flex items-center justify-center mx-auto shadow-lg">
                      ...
                      <p className="text-zinc-600 dark:text-zinc-400 text-sm">
                        Enter your S3 bucket name, region, and AWS credentials.
                      </p>
                    </div>
                    ...
                    <div className="text-center">
                      <div className="relative mb-4">
                        <div className="w-14 h-14 bg-zinc-900 dark:bg-zinc-100 rounded-2xl flex items-center justify-center mx-auto shadow-lg">
                          <Key className="w-7 h-7 text-white dark:text-zinc-900" />
                        </div>
                        <div className="absolute -top-2 -right-2 w-7 h-7 bg-emerald-500 rounded-full flex items-center justify-center text-white font-bold text-sm">
                          2
                        </div>
                    ...
                    <div className="text-center">
                      <div className="relative mb-4">
                        <div className="w-14 h-14 bg-zinc-900 dark:bg-zinc-100 rounded-2xl flex items-center justify-center mx-auto shadow-lg">
                          <Zap className="w-7 h-7 text-white dark:text-zinc-900" />
                        </div>
                        <div className="absolute -top-2 -right-2 w-7 h-7 bg-emerald-500 rounded-full flex items-center justify-center text-white font-bold text-sm">
                          3
                        </div>
                      ...
                      <p className="text-zinc-600 dark:text-zinc-400 text-sm">
                        Upload, download, and organize your S3 files visually.
                      </p>
                    </div>
                  </div>

                  <div className="flex justify-center items-center mt-10 space-x-6 text-zinc-400 dark:text-zinc-600">
                    <Upload className="w-5 h-5" />
                    <div className="h-px bg-zinc-300 dark:bg-zinc-700 w-6"></div>
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                  <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <p className="text-zinc-500 text-sm text-center">
                      © 2025 S3cretBox. All operations are performed
                      client-side.
                    </p>
                    <div className="flex gap-4">
                      <a
                        href="https://github.com/AaravAgarwal05/s3cretbox"
                        className="hover:text-zinc-200 transition-colors duration-200"
                      >
                        <Github className="w-5 h-5" />
                      </a>
                      <a
                        href="#mailto:aarav.knp.08@gmail.com"
                        className="hover:text-zinc-200 transition-colors duration-200"
                      >
